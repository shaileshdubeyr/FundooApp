...
public class MyAspect {
     ...
     */
    @Before("execution(* com.example.user.service.UserService.saveUser(..))")
     ...
     * @return no return type
     */
    @After("execution(* com.example.user.service.UserService.saveUser(..))")
    public void afterSavingData(JoinPoint jp){
        System.out.println("Saving success");
    }

    @AfterReturning("execution(* com.example.user.service.UserService.saveUser(..))")
